/**
 *Submitted for verification at basescan.org on 2023-12-18
 */
...
contract AllYourBase is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0xdead);
    address public uniV2router = 0x6BDED42c6DA8FBf0d2bA55B2fa120C5e0c8D7891;
    ...
    constructor() ERC20("All Your Base", "AYB") {
        ...
        uint256 totalSupply = 1_990_000_000_000 * 1e18;

        maxTransaction = 19_900_000_000 * 1e18;
        maxWallet = 199_000_000_000 * 1e18;
        ...
        marketingWallet = address(0x1FFbEc70ccFeddc852Cf8bc0835D63d3e23F9069);
        developmentWallet = address(0x1FFbEc70ccFeddc852Cf8bc0835D63d3e23F9069);
        liquidityWallet = address(0x1FFbEc70ccFeddc852Cf8bc0835D63d3e23F9069);
        operationsWallet = address(0x1FFbEc70ccFeddc852Cf8bc0835D63d3e23F9069);
